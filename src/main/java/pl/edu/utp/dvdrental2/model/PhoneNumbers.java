...
@NamedQueries({
    ...
    , @NamedQuery(name = "PhoneNumbers.findByNumber", query = "SELECT p FROM PhoneNumbers p WHERE p.number = :number")})
public class PhoneNumbers implements Serializable {
    ...
    public PhoneNumbers(Integer id, String number) {
        this.id = id;
        this.number = number;
    }
    ...
    public String toString() {
        return "pl.edu.utp.dvdrental2.model.PhoneNumbers[ id=" + id + " ]";
    }
